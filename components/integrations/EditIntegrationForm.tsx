...
export default function EditIntegrationForm({
  ...
  const [formData, setFormData] = useState({
    ...
    schedule: {
      ...
      time: integration.schedule.time,
    },
  });
    ...
    try {
      const response = await fetch(`/api/integrations/${integration._id}`, {
        ...
        body: JSON.stringify({
          ...
          config: {
            apiEndpoint: formData.config.apiEndpoint || undefined,
            apiKey: formData.config.apiKey || undefined,
            username: formData.config.username || undefined,
            password: formData.config.password || undefined,
            database: formData.config.database || undefined,
            port: formData.config.port || undefined,
          },
      ...
      if (!response.ok) {
        ...
        throw new Error(errorData.error || 'Entegrasyon güncellenirken bir hata oluştu');
      }

      router.push(`/dashboard/integrations/${integration._id}`);
      router.refresh();
    } catch (err: any) {
      setError(err.message || 'Entegrasyon güncellenirken bir hata oluştu');
    } finally {
      setIsSaving(false);
    }
  };
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex flex-wrap items-center justify-between gap-4 mb-6">
          <div className="flex-1 min-w-0">
            ...
            <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Entegrasyon Düzenle</h1>
            <p className="text-gray-600 dark:text-gray-400 mt-1">
              {integration.name} entegrasyonunun ayarlarını güncelleyin
            </p>
          </div>
        </div>
          ...
          <Card>
            ...
            <CardContent className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                <Input value={integration.type.toUpperCase()} disabled />
              </div>
              ...
              <div className="pt-4 border-t border-gray-200 dark:border-gray-700">
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      <Label htmlFor="password">Şifre (Değiştirmek için yeni şifre girin)</Label>
                      <Input
                        id="password"
                        type="password"
              ...
              <div className="flex items-center justify-end gap-3 pt-4 border-t border-gray-200 dark:border-gray-700">
                <Button type="button" variant="outline" asChild>
                  <Link href={`/dashboard/integrations/${integration._id}`}>İptal</Link>
                </Button>
