            ...
            <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
              <div className="flex flex-col gap-6 text-center lg:text-left">
                <h1 className="text-4xl font-extrabold tracking-tighter text-gray-900 dark:text-white sm:text-5xl md:text-6xl">
                  Akıllı Sözleşme Yönetiminin Geleceği, Basitleştirildi
                </h1>
                <p className="max-w-xl text-gray-600 dark:text-gray-300 md:text-lg">
                  Papirai, organizasyonel hiyerarşileri, kullanıcı yönetimini, sözleşme editörünü, versiyonlamayı, uyum kontrollerini, onay süreçlerini ve harici sistem entegrasyonlarını destekleyen bir akıllı sözleşme platformudur.
                </p>
              ...
              <div className="flex items-center justify-center">
                <div className="h-80 w-full rounded-xl bg-gray-200 dark:bg-gray-800/50 overflow-hidden">
                  <img
                    alt="Blockchain illustration"
                    className="h-full w-full rounded-xl object-cover"
                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuDh0lOCLgryiOCUmFKiN1eVpTy3enfBnUAOfy9WRqPtLFijNSmh7LvPjf-JXi9NPOHlL_SLxoRZQy3RQm5P-6h4qu3v9Lu259f3KMhbY87OakbK3P-fY1Zc3kJqMa5jBSiv34BRSbNN6x-E6UHGT9yvtXVJjRYleRKupi53cVlENxKSEWtmN2zNIljHgTGuKbUcVDELvAw9FziZHGudgDZpQ89ERRg7m5gtXF9bH0D2N3_U4pnLXXXciJeO58A812wkCWJvrbU2EWLr"
                  />
                </div>
              </div>
            </div>
        ...
        <section id="features" className="w-full bg-gray-100/50 py-20 dark:bg-white/5 lg:py-24">
          <div className="container mx-auto max-w-6xl px-6">
            <div className="flex flex-col items-center gap-6 text-center">
              ...
              <p className="max-w-3xl text-gray-600 dark:text-gray-300 md:text-lg">
        ...
        <section className="w-full py-20 lg:py-24">
          <div className="container mx-auto max-w-6xl px-6">
            <div className="flex flex-col items-center gap-4 text-center">
              ...
              <p className="max-w-2xl text-gray-600 dark:text-gray-300 md:text-lg">
          ...
          <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
            <div className="flex flex-col gap-4">
              <div className="flex items-center gap-3 text-gray-900 dark:text-white">
                ...
                <h2 className="text-xl font-bold">Papirai</h2>
              </div>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-2">
                <li>
                  <a className="text-sm text-gray-600 hover:text-primary dark:text-gray-300 dark:hover:text-primary" href="#features">
                    Özellikler
                  </a>
                </li>
                <li>
  ...
  return (
    <div className="flex flex-col items-center gap-4 rounded-xl bg-gray-100/50 p-6 text-center dark:bg-white/5">
      ...
      <div>
        ...
        <p className="mt-2 text-sm text-gray-600 dark:text-gray-300">&quot;{quote}&quot;</p>
      </div>
    </div>
  );
}
